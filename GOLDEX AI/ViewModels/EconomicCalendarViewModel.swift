...
class EconomicCalendarViewModel: ObservableObject {
    ...
    @Published var filteredEvents: [EconomicEvent] = []
    ...
    private func generateSampleEvents() -> [EconomicEvent] {
        return [
            EconomicEvent(
                id: UUID(),
...
enum EconomicImpact: String, CaseIterable {
    case low = "Low"
    case medium = "Medium"
    case high = "High"
...
enum CalendarTimeframe: String, CaseIterable {
    case today = "Today"
