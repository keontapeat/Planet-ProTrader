//
//  GoldexFirebaseIntegration.swift
//  GOLDEX AI
//
...
@MainActor
class GoldexFirebaseIntegration: ObservableObject {
    ...
    func storeFlipGoal(userId: String, flip: SharedTypes.FlipGoal) async {
        let flipData: [String: Any] = [
            ...
            "strategy": [
                ...
                "min_confidence": flip.strategy.minConfidence,
                "timeframes": flip.strategy.timeframes
            ],
            "created_at": Date()
        ]
