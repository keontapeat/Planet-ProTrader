...
int OnInit()
{
   ...
   Print("🚀 GOLDEX AI FIREBASE EA v7.0 INITIALIZED");
   ...
   Print("⚡ Ultra Aggressive: ", EnableUltraAggressive ? "ON" : "OFF");
   Print("🔄 Max Simultaneous Positions: ", MaxSimultaneousPositions);
...
void OnDeinit(const int reason)
{
   ...
   Print("🔥 Max Consecutive Wins: ", ConsecutiveWins);
...
{
   Print("🔄 Executing loss recovery strategy...");
...
{
   Print("🎯 Executing trading signal: ", signal.signalReason);
