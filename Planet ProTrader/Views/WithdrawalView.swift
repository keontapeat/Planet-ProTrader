    ...
    private var historyTab: some View {
        ScrollView {
            VStack(spacing: 16) {
                // Summary Stats
                HStack(spacing: 12) {
                    StatCard(title: "Total Withdrawn", subtitle: "All time", value: "$47,392", icon: "arrow.down.circle", color: .green)
                    StatCard(title: "This Month", subtitle: "January", value: "$12,847", icon: "calendar", color: .blue)
                    StatCard(title: "Pending", subtitle: "Processing", value: "$0", icon: "clock", color: .orange)
                }
                .padding(.horizontal, 20)
