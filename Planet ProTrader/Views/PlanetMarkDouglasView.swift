...
struct PlanetMarkDouglasView: View {
    ...
    private var botArmyOverview: some View {
        VStack(spacing: 20) {
            // Stats overview
            LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 16) {
                StatCard(title: "Total Bots", value: "5,000+", icon: "person.3.fill", color: .blue, trend: "+500")
                StatCard(title: "Active Now", value: "4,847", icon: "bolt.fill", color: .green, trend: "↗️")
                StatCard(title: "Learning", value: "2,156", icon: "brain.head.profile", color: .orange, trend: "+156")
                StatCard(title: "Trading Live", value: "1,024", icon: "chart.line.uptrend.xyaxis", color: .purple, trend: "↑")
            }
