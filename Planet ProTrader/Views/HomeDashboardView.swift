        ...
        VStack(spacing: 16) {
            ...
            UltraPremiumCard {
                VStack(spacing: 16) {
                    ...
                    HStack(spacing: 20) {
                        HomeDashboardMetricView(title: "Balance", value: realTimeAccountManager.formattedBalance, color: .primary)
                        HomeDashboardMetricView(title: "Open P&L", value: realTimeAccountManager.formattedOpenPL, color: realTimeAccountManager.openPLColor)
                        HomeDashboardMetricView(title: "Win Rate", value: realTimeAccountManager.formattedWinRate, color: .green)
                    }
                }
            }
        }
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            UltraPremiumCard {
                VStack(spacing: 16) {
                    ...
                    HStack(spacing: 20) {
                        HomeDashboardMetricView(title: "High", value: "$2,380.50", color: .green)
                        HomeDashboardMetricView(title: "Low", value: "$2,365.20", color: .red)
                        HomeDashboardMetricView(title: "Volume", value: "High", color: .orange)
                    }
                }
            }
        }
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            UltraPremiumCard {
                VStack(spacing: 20) {
                    ...
                    HStack(spacing: 20) {
                        HomeDashboardMetricView(title: "Profit Factor", value: "2.43", color: DesignSystem.primaryGold)
                        HomeDashboardMetricView(title: "Max Drawdown", value: "3.2%", color: .red)
                        HomeDashboardMetricView(title: "Avg Trade", value: "$24.5", color: .green)
                    }
                }
            }
        }
...
struct HomeDashboardMetricView: View {
    let title: String
    let value: String
    let color: Color
