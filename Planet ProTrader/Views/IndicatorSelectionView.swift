...
struct IndicatorSelectionView: View {
        ...
        Button(action: {
            ...
            HStack(spacing: 16) {
                ...
                VStack(spacing: 4) {
                    ...
                    Text(getIndicatorSymbol(for: indicator))
                        .font(.caption2)
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(getIndicatorDescription(indicator: indicator))
                        .font(.caption)
                        .foregroundColor(.secondary)
                        .lineLimit(2)
                }
    ...
    private func getIndicatorSymbol(for indicator: TechnicalIndicator) -> String {
        switch indicator {
        case .sma: return "SMA"
        case .ema: return "EMA"
        case .rsi: return "RSI"
