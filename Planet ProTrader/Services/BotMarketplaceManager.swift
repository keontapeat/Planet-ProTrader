...
enum MarketplaceRiskLevelType: String, CaseIterable {
    case low = "Low"
    case medium = "Medium"
    case high = "High"
...
enum MarketplacePopularityLevelType: String, CaseIterable {
    case rising = "Rising"
