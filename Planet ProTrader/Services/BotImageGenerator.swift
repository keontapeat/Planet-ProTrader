...
struct BotVisualCharacteristics {
    ...
    enum AuraType: String, CaseIterable {
        ...
        case primaryGold = "Primary Gold Aura"
        ...
        var color: Color {
            ...
            case .primaryGold: return .primaryGold
            }
        }
    }
    ...
    enum BackgroundType: String, CaseIterable {
        ...
        case primaryGold = "Primary Gold Background"
        ...
        var gradient: [Color] {
            ...
            case .temple: return [.primaryGold, .yellow, .orange]
            case .primaryGold: return [.primaryGold, .primaryGold, .primaryGold]
            }
        }
    }
...
class BotImageGenerator: ObservableObject {
    ...
    func generateImagePrompt(for bot: MarketplaceBotModel) -> String {
        ...
        Bot Name: \(bot.name)
        Risk Level: \(bot.riskLevel.rawValue) 
        Rarity: \(bot.rarity.rawValue) 
        Category: \(bot.category.rawValue)
    ...
    func generateStatCardPrompt(for bot: MarketplaceBotModel) -> String {
        ...
        - Risk Level: \(bot.riskLevel.rawValue) with specialized trading focus
        """
    }
    ...
    private func getBodyType(for bot: MarketplaceBotModel) -> BotVisualCharacteristics.BodyType {
        switch bot.riskLevel {
        case .low: return .wizard
        case .medium: return .sleek
        case .high: return .warrior
    ...
    private func getAura(for bot: MarketplaceBotModel) -> BotVisualCharacteristics.AuraType {
        ...
        else if bot.riskLevel == .extreme { return .fire }
        else if bot.riskLevel == .low { return .ice }
    ...
    private func getPose(for bot: MarketplaceBotModel) -> BotVisualCharacteristics.PoseType {
        ...
        else if bot.tradingStyle == .technical { return .analyzing }
    ...
    private func getBackground(for bot: MarketplaceBotModel) -> BotVisualCharacteristics.BackgroundType {
        switch bot.category {
        case .scalper: return .cityscape
        case .swing: return .charts
        case .news: return .mountains
        case .technical: return .temple
        case .dayTrader: return .matrix
        case .arbitrage: return .space
        }
    }
    ...
    private func getPrimaryColorName(_ color: Color) -> String {
        ...
        else if color == .primaryGold { return "radiant gold" }
        else { return "neutral" }
    }
    ...
    private func getSecondaryColorName(_ color: Color) -> String {
        ...
        else if color == .primaryGold { return "bright gold" }
        else { return "white" }
    }
}
                ...
                .fill(
                    LinearGradient(
                        colors: [
                            ...
                            bot.riskLevel.color.opacity(0.6)
                        ],
