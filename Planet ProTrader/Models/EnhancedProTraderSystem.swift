...
struct EnhancedProTraderBot: Identifiable, Codable {
    ...
    var learningHistory: [SharedTypes.EnhancedLearningSession]
    ...
    private func performAdvancedTraining(with data: [EnhancedGoldDataPoint]) async -> SharedTypes.EnhancedLearningSession {
        ...
        return SharedTypes.EnhancedLearningSession(
            timestamp: Date(),
            dataPoints: data.count,
            xpGained: xpGain,
            confidenceGained: confidenceBoost,
            patternsDiscovered: patterns,
            aiEngineUsed: aiEngine.rawValue,
    ...
    mutating private func enhanceAIEngine(basedOn session: SharedTypes.EnhancedLearningSession) async {
...
// Preview removed - ContentView not available in this scope