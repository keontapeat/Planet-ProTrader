...
struct TradingFuelModels {
    ...
    struct FuelAlert: Identifiable, Codable {
        ...
        enum AlertType: String, CaseIterable, Codable {
            ...
            var title: String {
                switch self {
                case .lowFuel: return "Low Trading Fuel ⚠️"
                case .criticalFuel: return "Critical Fuel Level 🔴"
    ...
    class FuelManager: ObservableObject {
        ...
        private func sendPushNotification(alert: FuelAlert, tank: FuelTank) {
            ...
            content.sound = alert.alertType.priority == .high ? .defaultCritical : .default
...
// MARK: - Sample Data Extension (Outside the main struct)
