        ...
        UltraPremiumCard {
            VStack(spacing: 12) {
                ...
                LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 2), spacing: 12) {
                    OpusMetricCard(title: "Optimizations", value: "\(hyperEngine.performanceMetrics.totalOptimizations)", icon: "gearshape", subtitle: "Total", color: .blue)
                    OpusMetricCard(title: "Avg Speed", value: "\(String(format: "%.1f", hyperEngine.performanceMetrics.averageSpeedGain))x", icon: "bolt", subtitle: "Multiplier", color: .orange)
                    OpusMetricCard(title: "Efficiency", value: "\(String(format: "%.0f", hyperEngine.performanceMetrics.systemEfficiency * 100))%", icon: "checkmark", subtitle: "System", color: .green)
                    OpusMetricCard(title: "Alignment", value: "\(String(format: "%.0f", hyperEngine.performanceMetrics.markDouglasAlignment * 100))%", icon: "brain", subtitle: "Mental", color: .purple)
                }
            }
        }
    }
